...
class ProfileSettings:
	...
	func fill():
		...
		append_key(Settings.SV_KEY_HISTORY_BACK_DEF, "Control+Z", Settings.SV_KEY_HISTORY_BACK2_DEF, "", Settings.SV_KEY_HISTORY_BACK, Settings.SV_KEY_HISTORY_BACK2)
		append_key(Settings.SV_KEY_HISTORY_FORWARD_DEF, "Control+Y", Settings.SV_KEY_HISTORY_FORWARD2_DEF, "", Settings.SV_KEY_HISTORY_FORWARD, Settings.SV_KEY_HISTORY_FORWARD2)
